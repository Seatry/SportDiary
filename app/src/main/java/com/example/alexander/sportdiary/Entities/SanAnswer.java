...
@Entity(foreignKeys =
        ...
        @ForeignKey(
                entity = SanQuestion.class, parentColumns = "id", childColumns = "question_id", onDelete = CASCADE, onUpdate = CASCADE
        )},
...
public class SanAnswer {
    ...
    public SanAnswer(long dayId, long questionId, int answer) {
        this.dayId = dayId;
